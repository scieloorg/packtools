...
def sort_by_reference_list(publication_events, standard_publication_order):
    ...
    Note:
    -----
    If an event in 'publication_events' is not found in 'standard_publication_order', it will be placed at the end of the sorted list.

    Examples:
    ---------
    publication_events = ["preprint", "corrected", "received"]
    standard_publication_order = ["received", "rev-request", "rev-recd", "accepted", "corrected"]
    sorted_events = sort_by_reference_list(publication_events, standard_publication_order)
    print(sorted_events)
    # Output: ['received', 'corrected', 'preprint']
    # 'received' and 'corrected' are sorted according to 'standard_publication_order',
    # while 'preprint' is not in 'standard_publication_order' and goes to the end.

...
class ArticleAuthorsValidationTest(unittest.TestCase):
    ...
    def test_peer_review_as_ext_link_success(self):
        self.maxDiff = None
        self.xmltree = etree.fromstring(
            """
            <article xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:xlink="http://www.w3.org/1999/xlink" 
            ...
            <p>This report can be read on:<related-article related-article-type="reviewer-report" ext-link-type="uri" xlink:href="https://publons.com/publon/000000/#review-2020xxx">Publons</related-article></p>
            </fn>
            </fn-group>
            </article-meta>
            </front>
        ...
        obtained = list(PeerReviewsValidation(
            self.xmltree,
            related_article_type_list=["reviewer-report"],
            link_type_list=['uri']
        ).validate())
        expected = [
            {
                ...
                "validation_type": "value in list",
                "response": "OK",
                'expected_value': ['reviewer-report'],
                'got_value': 'reviewer-report',
                'message': "Got reviewer-report, expected ['reviewer-report']",
                "advice": None,
                'data': {
                    'ext-link-type': 'uri',
                    'href': 'https://publons.com/publon/000000/#review-2020xxx',
                    'id': None,
                    'parent': 'article',
                    'parent_article_type': 'research-article',
                    'parent_id': None,
            ...
            },
            {
                ...
                'validation_type': 'exist',
                "response": "OK",
                'expected_value': 'https://publons.com/publon/000000/#review-2020xxx',
                'got_value': 'https://publons.com/publon/000000/#review-2020xxx',
                'message': 'Got https://publons.com/publon/000000/#review-2020xxx, expected https://publons.com/publon/000000/#review-2020xxx',
                "advice": None,
                'data': {
                    'ext-link-type': 'uri',
                    'href': 'https://publons.com/publon/000000/#review-2020xxx',
    ...
    def test_peer_review_as_ext_link_fail(self):
        self.maxDiff = None
        self.xmltree = etree.fromstring(
            """
            <article xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <fn>
            <label>Reviewer</label>
            <p>This report can be read on:<related-article related-article-type="reviewer-report" ext-link-type="" xlink:href="">Publons</related-article></p>
            </fn>
            </fn-group>
            </article-meta>
            </front>
        ...
        expected = [
            ...
            },
            {
                ...
                'expected_value': 'a value for <related-article @xlink:href>',
                'got_value': '',
                'message': 'Got , expected a value for <related-article @xlink:href>',
                'advice': 'provide a value for <related-article @xlink:href>',
                'data': {
                    'ext-link-type': '',
                    'href': '',

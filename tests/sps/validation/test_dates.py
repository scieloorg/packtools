...
>>>>>>> 94dfbcc (Adiciona FulltextDatesValidation e seus testes)
...
class HistoryDatesValidationTest(TestCase):
    ...
    def test_date_is_complete_a_date_with_missing_year(self):
        ...
        expected = (
            False,
            "a valid date for pub-date",
            "-02-05",
            "pub-date must be complete",
            "Provide 'year' of the date",
        )
...
class ArticleDatesValidationTest(TestCase):
    ...
    def test_validate_collection_date_success(self):
        ...
        xml_tree = get_xml_tree(xml_str)
        obtained = dates.ArticleDatesValidation(xml_tree).validate_collection_date(
            "2023"
        )
        expected = {

...
class DataAvailabilityTest(unittest.TestCase):
    ...
    def test_items_by_lang(self):
        ...
        self.assertEqual(items_by_lang['pt'][0]['text'], 'Data will be available upon request.')
        self.assertEqual(items_by_lang['pt'][1]['tag'], 'fn')
        self.assertEqual(items_by_lang['pt'][1]['text'], 'The data and code used to generate plots and perform statistical analyses have been uploaded to the Open Science Framework archive.')

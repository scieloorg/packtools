from packtools.lib.normalizer import extract_number_and_supplment_from_issue_element
...
class TestSPS_Assets(TestCase):
    ...
    def test_assets_returns_alternatives(self):
        ...
        for i, item in enumerate(expected):
            with self.subTest(i):
                ...
                self.assertEqual(item["id"], result[i]._parent_node_with_id.get('id'))
    ...
    def test_assets_returns_1_table(self):
        ...
        self.assertEqual(expected[0]["id"], result[0]._parent_node_with_id.get('id'))

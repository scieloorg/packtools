...
class PipelinePubmed(unittest.TestCase):
    ...
    def test_xml_pubmed_citations(self):
        ...
        xml_tree = ET.fromstring(
            ...
            '<ref id="B2">'
            '<label>2.</label>'
            '<mixed-citation>2. Kwon JA, Jeon W, Park EC, Kim JH, Kim SJ, Yoo KB, et al. Effects of disease detection on changes in smoking behavior. Yonsei Med J. 2015;56(4): 1143-9. DOI:https://doi.org/10.3349/ymj.2015.56.4.1143</mixed-citation>'
            '<element-citation publication-type="journal">'
            '<person-group person-group-type="author">'
            '<name>'

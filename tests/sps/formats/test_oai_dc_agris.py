...
class TestPipelineOaiDcAgris(unittest.TestCase):
    ...
    def test_xml_oai_dc_agris_title_pipe_without_lang(self):
        ...
        with self.assertRaises(AddLanguageError) as context:
            xml_oai_dc_agris_title_pipe(xml_oai_dc_agris, xml_tree)

        self.assertEqual(str(context.exception),
                         "Unable to add language Argument must be bytes or unicode, got 'NoneType'")
    ...
    def test_xml_oai_dc_agris_date_without_date(self):
        xml_tree = ET.fromstring(
            '<article '
            'xmlns:mml="http://www.w3.org/1998/Math/MathML" '
            'xmlns:xlink="http://www.w3.org/1999/xlink" '
    ...
    def test_xml_oai_dc_agris_availability_pipe_without_doi(self):
        data = {
            'location': 'SCIELO'
        }
    ...
    def test_xml_oai_dc_agris_availability_pipe_without_location_and_doi(self):
        xml_tree = ET.fromstring(
            '<article xmlns:mml="http://www.w3.org/1998/Math/MathML" '
            'xmlns:xlink="http://www.w3.org/1999/xlink" '
            'article-type="research-article" dtd-version="1.0" '
    ...
    def test_xml_oai_dc_agris_citation_pipe_without_title(self):
        xml_tree = ET.fromstring(
            '<article '
            'xmlns:mml="http://www.w3.org/1998/Math/MathML" '
            'xmlns:xlink="http://www.w3.org/1999/xlink" '
    ...
    def test_xml_oai_dc_agris_citation_pipe_without_identifier(self):
        xml_tree = ET.fromstring(
            '<article '
            'xmlns:mml="http://www.w3.org/1998/Math/MathML" '
            'xmlns:xlink="http://www.w3.org/1999/xlink" '
    ...
    def test_xml_oai_dc_agris_citation_pipe_without_number(self):
        xml_tree = ET.fromstring(
            '<article '
            'xmlns:mml="http://www.w3.org/1998/Math/MathML" '
            'xmlns:xlink="http://www.w3.org/1999/xlink" '
    ...
    def test_xml_oai_dc_agris_citation_pipe_chronology(self):
        xml_tree = ET.fromstring(
            '<article '
            'xmlns:mml="http://www.w3.org/1998/Math/MathML" '
            'xmlns:xlink="http://www.w3.org/1999/xlink" '
